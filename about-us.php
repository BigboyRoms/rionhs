        ...
        <div class="col">
          <div class="home_content text-center">
            ...
            <!-- <div class="breadcrumbs">
              <ul>
                <li><a href="index.php" style="color: black; font-size: 30px; font-weight: 600;">Home</a></li>
                <li style="color: maroon; font-size: 18px; font-weight: 600;">About us</li>
              </ul>
            </div> -->
          </div>
        </div>
...
<div class="container mt-5">
  <div class="row">
    ...
    <div class="col-md-6">
      ...
      <div class="principal">
        <h3>Name: Vivian P. Maducdoc</h3>
        <p style="color: black;">Year: <span class="date">2018-2021</span></p>
        <p style="color: black;">Position: Ph. D., Principal III</p>
      </div>
    </div>
  </div>
</div>
...
<div class="teachers mt-5">
  <div class="container" style="">
    ...
    <div class="row teachers_row text-center" id="principal" loading="lazy" style="color: black;">
        ...
        <div class="contact_content">
          ...
          <div class="row" style="border: 3px solid black;">
              ...
              <div class="contact_info_container">
                <div class="contact_info">
                  <div class="contact_info_item">
                    ...
                    <div class="contact_info_line" style="color: black;">Camia B. Rio Chico, General Tinio, Nueva Ecija
                    </div>
                  </div>
                  <div class="contact_info_item">
                    <div class="contact_info_title">Phone:</div>
                    <div class="contact_info_line" style="color: black;">044-940-3513</div>
                  </div>
                  <div class="contact_info_item">
                    <div class="contact_info_title">Email:</div>
                    <div class="contact_info_line" style="color: black;">riochicohighschool548@gmail.com</div>
                  </div>
            ...
            <form action="sendemail/send.php" method="post">
              ...
              <input type="text" id="name" name="name" style="border: 1px solid black;" required>

              <label for="email" style="color: black;">Email</label>
              <input type="email" id="email" name="email" style="border: 1px solid black;" required>

              <label for="message" style="color: black;">Message</label>
              <textarea id="message" name="message" style="border: 1px solid black;" required></textarea>

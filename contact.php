...
<div class="container mt-5">
	<div class="row text-center">
		<div class="col">
			<h3 class="contact_info_title" style="color: maroon;"><i class="fa fa-envelope"></i> Email
			</h3>
					...
					<div class="">
						...
						<!-- <div class="col-md-4 ml-3">
							<div class="contact_info_container">
								<div class="contact_info_main_title text-center" style="background-color: maroon; border-radius: 30px; color: white;">Contact Us</div>
								<div class="contact_info">
									<div class="contact_info_item">
										<br><br>
										<div class="contact_info_title" style="color: maroon; font-size: 23px;">Address:
										</div>
										<div class="contact_info_line" style="color: black; font-size: 14px;">Camia B.
											Rio Chico, General
											Tinio, Nueva Ecija</div>
									</div>
									<div class="contact_info_item mt-4">
										<div class="contact_info_title" style="color: maroon; font-size: 23px;">Phone:
										</div>
										<div class="contact_info_line" style="color: black; font-size: 14px;">
											044-940-3513</div>
									</div>
									<div class="contact_info_item mt-4">
										<div class="contact_info_title" style="color: maroon; font-size: 23px;">Email:
										</div>
										<div class="contact_info_line" style="color: black; font-size: 14px;">
											riochicohighschool548@gmail.com</div>
									</div>
								</div>
							</div>
						</div> -->

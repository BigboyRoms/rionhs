...
<style>
  ...
  /* ANNOUNCEMENT */
  /* Custom CSS for adding lines to the news heading */
  .custom-news-heading {
    position: relative;
  }
      ...
      <div class="row">
        <div class="col">
          <div class="home_content text-center">
            <!-- <div class="home_title">ANNOUNCEMENT</div> -->
            <!-- <div class="breadcrumbs">
              <ul>
                <li><a href="index.php">Home</a></li>
                <li style="color: maroon">Announcement</li>
              </ul>
            </div> -->
          </div>
        </div>
...
<div class="news-section mt-5">
  <div class="container">
    <h2 class="title text-center" style="color: maroon;">Announcements</h2>
    <div class="card">
      ...
      <!-- <div class="card-header h5" style="color: black;">
      ...
      <div id="multi-item-example" class="carousel slide carousel-multi-item carousel-multi-item-2"
        ...
        <div class="carousel-inner" role="listbox">
          ...
          <div class="form-group col-md-4 col-sm-6">
            <select class="form-control" name="announce_cat_history" id="announce_cat_history">
              Your select options go here
            </select>
          </div>
          ...
          <div class="carousel-item active" id="carousel-item2">
            Your content for the carousel item goes here
          </div>
      ...
      <!--/.Carousel Wrapper-->
      <div class="container">
        <h2 class="mt-5 text-center mb-5 custom-news-heading" style="color: maroon;">News</h2>

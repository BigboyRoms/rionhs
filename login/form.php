          ...
          <div class="col-md-6">
            <div class="form-block">
              <div class="text-center mb-4">
                <a href="../index.php">
                  <img src="../assets/images/RCNHSLOGONEW.png" alt="Logo" class="rounded-circle" width="100">
                </a>
              </div>
              <div class="text-center mb-5">
                <h3 class="text-dark font-italic">FACULTY LOGIN</h3>
              </div>
              <form action="#" method="post">
                ...
                <div class="form-group first">
                  <label for="user_username">Email or Username</label>
                  <input type="text" class="form-control" placeholder="Enter email or username" id="user_username"
                    name="user_username">
                </div>

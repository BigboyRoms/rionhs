  ...
  function getAllData() {
    $.get({
      ...
      success: function (data) {
        ...
        let container = $("#principal");
        lazyLoadImages(container);
        newData.forEach((teachers, i) => {
          container.append(
            '<div class="col-lg-4 col-md-6 mx-auto">' +
              '<div class="teacher">' +
              ' <div class="teacher_image"><img style="height: 180px; width: 180px; border: 1px solid white; border-radius: 50%;" src="assets/images/teachers/' +
    ...
    success: function (data) {
      ...
      newData.forEach((teachers, i) => {
        container.append(
          '<div class="col-lg-4 col-md-6 mx-auto">' +
            '<div class="teacher">' +
            ' <div class="teacher_image"><img style="height:200px; width:auto; border: 1px solid white; border-radius: 50%;" src="assets/images/teachers/' +
            teachers.teacher_fname +
            "/" +
            teachers.teacher_profile +
            '" onerror="this.src=' +

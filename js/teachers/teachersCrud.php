...
if (isset($_GET['getData'])) {
    ...
    $DBCRUDAPI->selectFullleftjointeacher("teachers", "teacher_positions", "teacher_position_id", "teacher_pos_id", "WHERE teacher_pos_id != 15 AND teacher_pos_id != 21 AND teacher_pos_id != 22 AND teacher_pos_id != 12 AND teacher_pos_id != 19 AND teacher_pos_id != 20 ");
    $data = $DBCRUDAPI->sql;
    $res = array();
    while ($datass = mysqli_fetch_assoc($data)) {
        $res[] = $datass;

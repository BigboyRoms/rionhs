$(document).ready(function () {
      ...
      success: function (data) {
        ...
        newData.forEach((permissions, i) => {
          ...
          $("<button>", {
            ...
            "data-id": permissions.permission_id,
            id: "delete",
            html: "Delete",
          }).appendTo(tableData);
  ...
  $("#create-new").click(function () {
    $("#modalMainLabel").html("Add Permission");
  ...
  function update(index) {
    $("#modalMain").modal("show");
    $("#modalMainLabel").html("Update Permission");
  ...
  function deletes(id) {
    $.post({
      url: entity + "/" + entity + "Crud.php",
      data: { permission_id: id, delete: "delete" },
      success: function (data) {
        data = JSON.parse(data);
        if (data.success) {
          $("#formBodyData").trigger("reset");
  ...
  function view(index) {
    $("#modalMain").modal("show");
    $("#modalMainLabel").html("View permissions");
    let models = dataArray[index];
    Object.keys(models).map((key) => {

		...
		success: function (data) {
			...
			newData.forEach((announcements, i) => {
				...
				announce_gal.append(
					...
					'<img src=' + 'assets/images/announcements/' + announcements.announcement_category_id + '/' + announcements.announcement_image + ' alt="Image 1" class="card-img-top">' +
